...
[![x-cmd/install — jq Code Quality Monitoring Repo Card](https://repo.x-cmd.io/jq.svg?lang=zh)](https://x-cmd.com/install/jq)
...
合计: **56,908** 行代码（覆盖前 5 种语言、共 **103** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| C | 30,415 | 7,836 | 3,565 | 45 |
| Yaml | 18,688 | 52 | 2,709 | 11 |
...
- **最新版本**: `jq-1.8.2` (2026-06-20)
- **最近提交**: 2026-09-15
- **Release 含资产**: 29 个

## 流行度

- **Star**: 35,615 · **Fork**: 1,973 · **开放 issue**: 2,352 · **贡献者**: 242

## 累计统计

- **发布数**: 16 · **已合并 PR**: 716 · **开放 PR**: 127 · **已关闭 issue**: 1997 · **开放 issue**: 355 · **提交数**: 1941

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-19 | 0 | 3 | 21 | 2 | 0 | 7 |
| last60d | 2026-07-20 | 0 | 8 | 28 | 2 | 1 | 9 |
| 90d | 2026-06-20 | 1 | 12 | 31 | 11 | 6 | 14 |
| last180d | 2026-03-22 | 1 | 29 | 42 | 21 | 8 | 48 |
| 360d | 2025-09-23 | 1 | 66 | 50 | 48 | 20 | 88 |
| last720d | 2024-09-28 | 3 | 164 | 62 | 111 | 34 | 207 |
...
jq 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `jq` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/jq.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260918.yml` · 2026-09-18T06:21:04Z._
